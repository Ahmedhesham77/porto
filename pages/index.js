...
const Home = () => {
  return (
    <div className="bg-primary/60 h-full">
      {/* text */}
      <div className=" w-full h-[95%] bg-gradient-to-r from-primary/10 via-black/30 to-black/10">
        <div className="text-center flex flex-col justify-center xl:pt-40 xl:text-left h-full container mx-auto lg:flex-row lg:justify-between lg:pt-20">
          <div className="xs:mt-[2rem]">
            ...
            {/* subtitle */}
            <motion.p variants={fadeIn("down", 0.3)} initial="hidden" animate="show" exit="hidden" className=" max-w-sm xl:max-w-xl mx-auto xl:mx-0 mb-8 xl:mb-16  sm:text-[14px]  md:text-[18px] lg:text-[20px] lg:mx-0 xs:text-[12px] xs:mb-0  ">
          ...
          {/* Btn */}
          <div className="flex justify-center xl:hidden relative md:x-[100%] lg:items-center z-50000 ">
            <ProjectsBtn />
          </div>
